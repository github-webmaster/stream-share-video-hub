...
echo "  Backend Health: https://${DOMAIN:-yourdomain.com}/health"
echo ""
echo "IMPORTANT: Configure Cloudflare DNS & SSL:"
echo "  1. DNS: Add A record @ -> YOUR_SERVER_IP (☁️ Proxied)"
echo "  2. SSL/TLS: Set mode to 'Flexible' in Cloudflare dashboard"
echo "  3. Verify .env has HTTPS URLs:"
echo "     CORS_ORIGIN=https://${DOMAIN:-yourdomain.com}"
echo "     VITE_API_URL=https://${DOMAIN:-yourdomain.com}/api"
echo ""
